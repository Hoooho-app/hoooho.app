...
test('ongoing sleep persists only its start state', () => {
  const result = validateJournal({ categories: ['sleep'], sleep: { sleepAt: '2026-09-11T20:36:00+08:00', kind: 'night', status: 'ongoing' } })
