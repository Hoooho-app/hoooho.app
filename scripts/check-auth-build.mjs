...
assert.doesNotMatch(sw, /api\/auth\/(?:register|nickname\/login)/)
console.log('Auth build contract passed: versioned entry, immediate SW activation, no auth API precache.')
