...
export const healthProfilePriorities: Record<HealthProfileType, HealthProfileSectionId[]> = {
  infant: ['basic','feeding','growth','allergy','vaccination','birth','examination','medication'],
  ...
  'elder-female': ['basic','medication','chronic','examination','surgery','mobility','fall','allergy','sleep','family-history'],
  'elder-male': ['basic','medication','chronic','examination','surgery','mobility','fall','allergy','sleep','family-history']
}
