...
export const healthProfileSections: HealthProfileSectionConfig[] = [
  { id: 'basic', title: '基础信息', description: '身高、体重、血型等基础资料', icon: 'file', fields: [
  ...
  { id: 'growth', title: '生长发育', description: '身长、体重、头围与发育变化', icon: 'activity', fields: [
  ...
  { id: 'feeding', title: '喂养与辅食', description: '奶量、辅食和食物反应', icon: 'utensils', fields: [
  ...
  { id: 'sleep', title: '睡眠与作息', description: '睡眠时长与日常作息规律', icon: 'sleep', fields: [
  ...
  { id: 'allergy', title: '过敏史', description: '药物、食物和环境过敏记录', icon: 'allergy', fields: [
  ...
  { id: 'medication', title: '长期用药', description: '长期使用的药物及用法', icon: 'pill', fields: [
  ...
  { id: 'history', title: '既往病史', description: '过往疾病、治疗和当前状态', icon: 'heart', fields: [
  ...
  { id: 'examination', title: '检查与检验', description: '体检、化验和影像结果', icon: 'stethoscope', fields: [
  ...
  { id: 'vaccination', title: '预防接种', description: '疫苗名称、剂次与接种记录', icon: 'syringe', fields: [
  ...
  { id: 'indicators', title: '关键健康指标', description: '血压、血糖、心率和体温趋势', icon: 'activity', fields: [
  ...
  { id: 'menstrual', title: '月经健康', description: '周期、经量和异常情况记录', icon: 'calendar', fields: [
  ...
  { id: 'care', title: '功能与照护', description: '行动能力、跌倒风险与照护信息', icon: 'care', fields: [
  ...
  { id: 'family-history', title: '家族健康史', description: '家庭成员的重要健康信息', icon: 'family', fields: [
  ...
  { id: 'birth', title: '出生资料', description: '出生体重、孕周与分娩情况', icon: 'baby', fields: [
