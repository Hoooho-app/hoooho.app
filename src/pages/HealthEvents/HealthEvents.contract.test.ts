...
test('进食入口保留通用勺子且时间线按具体饮食类型显示语义图标', () => {
  ...
  assert.match(journalCategoryIcon, /kind === 'snack'[\s\S]*name="snack"/)
  assert.match(journalCategoryIcon, /kind === 'meal'[\s\S]*name="meal"/)
  ...
  assert.match(journalCategoryIcon, /symptom: 'symptom'/)
