...
export function MainAppHeader({ title, action }: { title: string; action?: ReactNode }) {
  ...
  return (
    <>
      ...
      {switchedMemberName && (
        <div className="pointer-events-none fixed inset-x-0 bottom-[max(24px,env(safe-area-inset-bottom))] z-[60] mx-auto flex w-full max-w-[680px] justify-center px-4" aria-live="polite" role="status">
